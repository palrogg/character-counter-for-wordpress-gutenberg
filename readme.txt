=== Character Counter for Gutenberg ===
...
Installing "Character Counter for Gutenberg" can be done either by searching for "Character Counter for Gutenberg" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
